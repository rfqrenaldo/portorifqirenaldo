  ...
  <div className="inline-block animate-float lg:mx-0" data-aos="zoom-in" data-aos-delay="400">
    <div className="relative group">
      ...
      <div className="relative bg-black/10 backdrop-blur-xl border border-white/10 rounded-full px-4 py-1.5">
        <span className="bg-gradient-to-r from-[#F4EEE0] to-[#6D5D6E] text-transparent bg-clip-text sm:text-sm text-[0.7rem] font-medium flex items-center">
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#03001C] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] " id="Home">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                <div className={`absolute inset-0 bg-gradient-to-r from-[#F4EEE0]/10 to-[#6D5D6E]/10 rounded-3xl blur-3xl transition-all duration-700 ease-in-out ${
