...
const ExperienceCard = ({ experience }) => (
  <div className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
    <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-blue-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    
    <div className="relative z-10">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-gradient-to-br from-purple-500/20 to-blue-500/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
...
const experiences = [
  {
    ...
    description: "Served as an assistant lecturer for the Web Programming 2 Practicum course, providing academic support, mentoring students in practical web development, and assisting in the facilitation of lab sessions and project-based learning.",
    ...
    >
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#9290C3] to-[#535C91]">
          <span style={{
            color: '#9290C3',
            backgroundImage: 'linear-gradient(45deg, #9290C3 10%, #535C91 93%)',
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Explore my journey through projects, certifications, tech stacks, and experiences that define my continuous growth as a developer.
        </p>
      </div>
